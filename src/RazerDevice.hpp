...
private:
    ...
    static constexpr uint16_t PRODUCT_ID_DONGLE = 0x00B7;  // DeathAdder V3 Pro wireless dongle
    static constexpr uint16_t PRODUCT_ID_WIRED = 0x00B6;   // DeathAdder V3 Pro wired/charging
